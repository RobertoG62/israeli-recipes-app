    ...
    function updateStaticText() {
        ...
        if (heroTitle) {
            heroTitle.innerHTML = i18n.getLanguage() === 'he' ?
                'המטבח <span class="text-il-primary-light">הישראלי</span>' :
                '<span class="text-il-primary-light">Israeli</span> Cuisine';
        }
        ...
        if (footerText) {
            footerText.innerHTML = i18n.t('footer.tagline') + ' <span class="text-il-primary-light mx-1"><i class="fas fa-heart"></i></span>';
        }
